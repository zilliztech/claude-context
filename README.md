...
[![npm - core](https://img.shields.io/npm/v/@suoshengzhang/claude-context-core?label=%40zilliz%2Fclaude-context-core&logo=npm)](https://www.npmjs.com/package/@suoshengzhang/claude-context-core)
[![npm - mcp](https://img.shields.io/npm/v/@suoshengzhang/claude-context-mcp?label=%40zilliz%2Fclaude-context-mcp&logo=npm)](https://www.npmjs.com/package/@suoshengzhang/claude-context-mcp)
...
claude mcp add claude-context \
  ...
  -- npx @suoshengzhang/claude-context-mcp@latest
```
...
```json
{
  "mcpServers": {
    "claude-context": {
      "command": "npx",
      "args": ["@suoshengzhang/claude-context-mcp@latest"],
      "env": {
...
```json
{
  "mcpServers": {
    "claude-context": {
      "command": "npx",
      "args": ["-y", "@suoshengzhang/claude-context-mcp@latest"],
      "env": {
        "OPENAI_API_KEY": "your-openai-api-key",
        "MILVUS_ADDRESS": "your-zilliz-cloud-public-endpoint",
        "MILVUS_TOKEN": "your-zilliz-cloud-api-key"
...
2. Fill in the server details:
   ...
   - **Type**: `STDIO`
   - **Command**: `npx`
   - **Arguments**: `["@suoshengzhang/claude-context-mcp@latest"]`
...
- **`@suoshengzhang/claude-context-core`**: Core indexing engine with embedding and vector database integration
- **VSCode Extension**: Semantic Code Search extension for Visual Studio Code
- **`@suoshengzhang/claude-context-mcp`**: Model Context Protocol server for AI agent integration
...
The `@suoshengzhang/claude-context-core` package provides the fundamental functionality for code indexing and semantic search.

```typescript
import { Context, MilvusVectorDatabase, OpenAIEmbedding } from '@suoshengzhang/claude-context-core';
